    ...
    require = function (id) {
        if (!modules[id]) {
            try{
                ...
                console.log("未使用define('module', factory)");
                return;
            }
...
var cordova = require('cordova'),
    ...
    // XHR mode's main advantage is working around a bug in -webkit-umScroll, which
...
exports.load = function(callback) {
    ...
    injectIfNecessary('cordova/plugin_list', pathPrefix + 'static/3rdlib/cordova/cordova_plugins.js', function() {
